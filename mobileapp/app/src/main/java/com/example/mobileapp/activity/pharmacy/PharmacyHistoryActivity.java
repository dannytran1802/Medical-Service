...
public class PharmacyHistoryActivity extends AppCompatActivity implements CheckoutInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckoutAPI checkoutAPI = new CheckoutAPI(PharmacyHistoryActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.logout) {
            // show message
            AlertDialog.Builder builder = new AlertDialog.Builder(PharmacyHistoryActivity.this);
